...
public class NotifyLoadingGame : BaseNotify
{
    ...
    private IEnumerator LoadScene()
    {
        ...
        while (!asyncOperation.isDone)
        {
            ...
            loadingPercentText.SetText($"SUCESSFUL: {asyncOperation.progress * 100}%");
            if (asyncOperation.progress >= 0.9f)
            {
                if (UIManager.HasInstance)
                {
                    ...
                    loadingPercentText.SetText($"SUCESSFUL: {loadingSlider.value * 100}%");
                    ...
                    if (overlapFade != null)
                    {
                        overlapFade.Fade(1f,
                            ...
                            onFinish: () =>
                            {
                                ...
                                {
                                    AudioManager.Instance.PlayBGM(AUDIO.BGM_BASEMENT);
                                }
                            });
                    }
                }
